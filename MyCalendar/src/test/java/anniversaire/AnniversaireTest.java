...
public class AnniversaireTest {
    ...
    public void testDescription() {
        Anniversaire a = new Anniversaire("Anniversaire de Claire","Lui",LocalDateTime.now(), 45,"Claire");
    ...
    public void testIsBeforeTrue() {
        ...
        Anniversaire a = new Anniversaire("Anniversaire de Claire","Lui",dateDebut, 45,"Claire");
